                    ...
                    <li>
                        ...
                        <li>
                            <div class="top-nav-search">
                                ...
                                <form action="search.html">
                                {{-- driver id --}}
                                    <input class="form-control driver-id" type="hidden" name="driver-id" value="{{ auth()->user()->id }}">
                                </form>
                            </div>
                            {{-- id --}}
                ...
                <ul class="nav user-menu float-right">
                    ...
                    <li class="nav-item dropdown has-arrow">
                        <a href="#" class=" nav-link user-link" data-toggle="dropdown">
                            <span class="user-img"><img class="rounded-circle driver-profile" src="assets/img/user-06.jpg"
                                    width="30" alt="Admin">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget dash-widget5">
                            ...
                            <div class="dash-widget-info text-right">
                                ...
                                <span><b class="text-warning">Pending Registration</b></span><br>
                                <a class="btn btn-warning" href="{{ route('register.vehicle') }}">Get Started</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
