...
@section('script')
    <script>
        $(document).ready(function() {
            var driverAbout = JSON.parse(localStorage.getItem('driver-location')) || []
            console.log(driverAbout)
            var about = ''
            about = `<div class="row">
                                <div class="driver-info-container p-3">
                                    ...
                                    <div class="driver-information row p-5">
                                        <div class="col d-flex justify-content-center align-items-center p-0">
                                            <div>
                                                <p>Company Name: <span id="company-name">${driverAbout.vans[0].companyname}</span></p>
                                                <p>Name: <span id="driver-name">${driverAbout.vans[0].fullname}</span></p>
                                                <p>Age: <span id="driver-age">${driverAbout.age}</span></p>
                                            </div>
                                        </div>
                                        <div class="col d-flex justify-content-center align-items-center p-0">
                                            <div>
                                                <p>Address: <span id="driver-address">${driverAbout.barangay}, ${driverAbout.municipality}</span></p>
                                                <p>Contact Number: <span id="driver-contact">0${driverAbout.contact}</span></p>
                                                <p>Email: <span id="driver-email">${driverAbout.email}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
